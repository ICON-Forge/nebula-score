from ..nebula_spaceship_token import NebulaSpaceshipToken
...
class TestNebulaSpaceshipToken(ScoreTestCase):
    ...
    def setUp(self):
        ...
        self.score = self.get_score_instance(NebulaSpaceshipToken, self.test_account1)
    ...
    def test_gets_name(self):
        self.assertEqual("NebulaSpaceshipToken", self.score.name())
